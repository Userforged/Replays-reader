...
class SetGrouper:
    ...
    # 🎯 Constantes SF6 - Règles des sets
    MAX_ROUNDS_PER_SET = 3  # Street Fighter 6: maximum 3 rounds par set
    MIN_ROUNDS_PER_SET = 2  # Street Fighter 6: minimum 2 rounds par set
